...
### Specific plots
ggsave("best_forces.pdf", plot = p_force, width = 12, height = 7.5)
ggsave("best_hips.pdf", plot = p_hip_error, width = 12, height = 7.5)
ggsave("best_knees.pdf", plot = p_knee_error, width = 12, height = 7.5)
ggsave("best_phase.pdf", plot = p_pitch_vs_roll, width = 12, height = 7.5)
ggsave("best_all.pdf", plot = p_all, width = 12, height = 7.5)

pdf("best_trajectory.pdf", width = 12, height=7.5)
